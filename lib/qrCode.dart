                      ...
                      child: TextButton(
                        ...
                        onPressed: () async{
                          if(barcode!.code==null ){
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => ModifySheets(
                                  data: barcode!.code,
                                onSavedUser: (user) async{
                                  await UserSheetsApi.update1(user.registraion!, user.toJson());
                                  Navigator.of(context).popUntil((route) => route.isFirst);
                                })
                                )
                            );
                          ...
                          child: TextButton(
                            ...
                            onPressed: ()=>{
                              if(barcode!.code==null ){
                                ...
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) =>  ModifySheetsout(
                                      data: barcode!.code,
                                      onSavedUser: (user) async{
                                          await UserSheetsApi.update1(user.registraion!, user.toJson());
                                        Navigator.of(context).popUntil((route) => route.isFirst);
