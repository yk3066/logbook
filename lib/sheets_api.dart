...
''';
  ...
  static Future init1() async {
    try {
      ...
      _userSheet1 = await _getWorkSheet(spreadsheet, title: ' ${DateFormat('dd-MM-yy').format(DateTime.now())}');
  ...
  static Future<User?> getById1(String reg) async{
  ...
  static Future<User?> getByIdlate(String reg) async{
